...
class lab1_intro(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "Lab 1: AM Radio", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("Lab 1: AM Radio")
        ...
        self.settings = Qt.QSettings("GNU Radio", "lab1_intro")
        ...
        self._rf_gain_range = Range(10, 70, 5, 55, 200)
        ...
        self._center_freq_range = Range(10e6, 560e6, 100e3, 100e6, 200)
...
def main(top_block_cls=lab1_intro, options=None):
