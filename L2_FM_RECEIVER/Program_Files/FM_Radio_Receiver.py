...
class FM_Radio_Receiver(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        gr.top_block.__init__(self, "Lab_2", catch_exceptions=True)
        ...
        self._freq_range = Range(88e6, 400e6, 10e3, 95.65e6, 200)
        ...
        self._rf_gain_range = Range(0, 55, 5, 30, 200)
        self._rf_gain_win = RangeWidget(self._rf_gain_range, self.set_rf_gain, "Gain", "counter_slider", float, QtCore.Qt.Horizontal)
        ...
        self.connect((self.analog_fm_demod_cf_0, 0), (self.qtgui_waterfall_sink_x_0_0, 0))
